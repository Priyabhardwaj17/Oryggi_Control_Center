...
public class LoginTest extends BaseTest  {
	...
	public void testLoginWithUsername() throws InterruptedException {
		...
		loginPage.enterUserNameOrEmailField("Admin");
		loginPage.enterPassword("iitjmu@#2025");
	...
	public void testLoginWithEmail() throws InterruptedException {
		LoginPage loginPage = new LoginPage(driver);
		loginPage.enterUserNameOrEmailField("admin@oryggitech.com");
		loginPage.enterPassword("iitjmu@#2025");
		loginPage.clickLogin();
	...
	public void testLoginWithInvalidCredentials() throws InterruptedException {
	    LoginPage loginPage = new LoginPage(driver);
	    loginPage.enterUserNameOrEmailField("InvalidUser");
